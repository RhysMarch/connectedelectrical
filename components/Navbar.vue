...
<template>
  <header class="fixed w-full bg-white text-black z-50 shadow border-b border-gray-200">
    <div class="max-w-screen-xl mx-auto flex items-center justify-between px-6 py-4">
      ...
      <NuxtLink to="/" class="shrink-0" aria-label="Go to homepage">
        <img src="/LogoBlack.png" alt="Connected Electrical" class="h-12" />
      </NuxtLink>

      <!-- Right: Nav + Phone + Hamburger -->
      <div class="flex items-center gap-6">
        ...
        <a
            ...
            class="hidden md:inline text-base text-gray-900 hover:text-primary transition-colors underline underline-offset-4"
    ...
    <transition name="fade">
      <div
          v-if="mobileOpen"
          class="md:hidden mt-4 mx-4 bg-white border-t border-gray-200 shadow-inner p-4 space-y-4 rounded-lg"
      >
        <!-- Mobile Navigation -->
        <UNavigationMenu
        ...
        <a
            ...
            class="block text-base font-semibold text-gray-900 hover:text-primary transition-colors underline underline-offset-4 mt-3"
